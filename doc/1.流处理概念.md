...
- [1.流处理概念](#1流处理概念)
  ...
  * [1.2、流式计算的衡量指标：延迟和吞吐](#12流式计算的衡量指标：延迟和吞吐)
  * [1.3、时间语义](#13时间语义)
    + [a、处理时间-Processing Time 和 活动时间-Event Time](#a处理时间-Processing Time 和 活动时间-Event Time)
...
### a、处理时间-Processing Time 和 活动时间-Event Time
...
![img](https://github.com/yichao0803/myflink/raw/master/image/1Streaming-Processing-Concepts-3-7.jpg)一个解析Twitter标签的数据流图逻辑视角 来源：Streaming Processing With Apache Flink
...
* https://zhuanlan.zhihu.com/p/80754388
* https://www.cnblogs.com/tgzhu/p/7119477.html