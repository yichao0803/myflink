...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_java_0)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_scala_0)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_java_1)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_scala_1)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_java_2)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_scala_2)
...
- [**Java**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_java_3)
- [**Scala**](https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html#tab_scala_3)
...
并行执行
https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/parallel.html
Task 故障恢复
https://ci.apache.org/projects/flink/flink-docs-release-1.9/zh/dev/task_failure_recovery.html

Flink入门（二）——Flink架构介绍
https://cloud.tencent.com/developer/article/1553282
Apache Flink：特性、概念、组件栈、架构及原理分析
http://shiyanjun.cn/archives/1508.html
Flink学习(一)：Flink基本使用
https://juejin.im/post/5eb0e4935188256d5f4ce834