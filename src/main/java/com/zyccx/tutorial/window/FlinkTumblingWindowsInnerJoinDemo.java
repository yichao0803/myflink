...
import com.zyccx.tutorial.source.StreamDataSource;
import com.zyccx.tutorial.source.StreamDataSource1;
    ...
    public static void main(String[] args) throws Exception {
        ...
        leftStream.join(rigjhtStream)
                ...
                .apply(new JoinFunction<Tuple3<String, String, Long>,
                    ...
                    @Override
                    public Tuple5<String, String, String, Long, Long> join(
                            Tuple3<String, String, Long> first,
                            Tuple3<String, String, Long> second) {
