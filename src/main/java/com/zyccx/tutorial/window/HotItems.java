...
public class HotItems {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Path filePath = Path.fromLocalFile(new File("E:\\Git\\yichao0803\\myflink\\src\\main\\resources\\UserBehavior.csv"));
        ...
        // TonN 计算最热门商品
        DataStream<String> tomItems = windowedData
                .keyBy("windowEnd")
                .process(new TopNHotItems(3));// 求点击量前 3 的商品
